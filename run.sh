...
python reactiondataextractor2/reactiondataextractor/extract.py --path ./reaction.jpeg --output_dir ./ > /dev/null
echo "Extracting SMILEs from substrates..."
python reactiondataextractor2/reactiondataextractor/extract.py --path ./substrates.jpeg --output_dir ./ > /dev/null
